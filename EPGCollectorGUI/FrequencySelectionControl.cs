...
namespace EPGCentre
{
    public partial class FrequencySelectionControl : UserControl
    {
        ...
        internal bool UseSignalPresent { get { return (cbUseSignalPresent.Checked); } }
        internal bool SwitchAfterPlay { get { return (cbSwitchAfterPlay.Checked); } }
        internal bool RepeatDiseqc { get { return (cbRepeatDiseqc.Checked); } }
