...
namespace EPGCentre
{
    public partial class SelectMHWCategoryFile : Form
    {
        public string File { get { return (((string)lbFiles.SelectedItem) + ".cfg"); } }

        public SelectMHWCategoryFile()
        {
            InitializeComponent();
            ...
            {
                if (fileInfo.Name.Contains("MHW") && fileInfo.Name.EndsWith(".cfg"))
